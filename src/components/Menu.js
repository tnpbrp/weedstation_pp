            ...
            >
              {item.name !== "" ? (
                <Meta
                  title={item.name}
                  description={
                    <span className="text-price" style={textPriceStyle}>
                      {item.price + " ฿"}{" "}
                    </span>
                  }
                />
              ...
              {item.desc ? (
                <span title={""} style={{ color: "rgb(78, 47, 255)" }}>
                  * {item.desc}{" "}
                </span>
              ) : (
                ""
              ...
              {item.santiva || item.indica !== "" ? (
                ...
                >
                  <span
                    style={{
                      display: item.santiva ? "" : "none",
                      borderRight: item.indica ? "green 1px solid" : "",
                    }}
                  >
                    Santiva {item.santiva} %
                  </span>
                  <span style={{ display: item.indica ? "" : "none" }}>
                    Indica {item.indica} %
                  </span>
              ...
              {item.thc > 0 || item.cbd > 0 ? (
                <>
                  <Meta
                    title={""}
                    description={item.thc ? `THC : ${item.thc} %` : ""}
                  />
                  <Meta
                    title={""}
                    description={item.cbd ? `CBD : ${item.cbd} %` : ""}
                  />
                </>
              ) : (
